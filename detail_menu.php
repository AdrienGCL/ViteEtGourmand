            ...
            <div class="row marging-l-0 marging-t-l justify-content-center">
                <div class="col-10 m-0 p-0">
                    <div class="filter d-flex justify-content-center p-0 tertiary-text">
                        <i class="bi bi-chevron-left marging-l-s"></i>
                        <a class="text-decoration-underline marging-l-s marging-r-s tertiary-text" href="./menus.php">Revenir aux résultats</a>
                    </div>
                </div>
            </div>
            <div class="bg-extra-dark marging-t-l padding-t-l">
                ...
                <div class="row justify-content-center marging-t-l">
                ...
                <div class="row justify-content-center marging-t-s">
